...
function LicensePage() {
	...
	return (
		<div className={styles.div}>
			<Paragraph>
				{t('licenseTranslations.firstPar')}
			</Paragraph>
			...
			<Paragraph>
                ...
                предпринимаемые Scientific Equipment (далее – Оператор).
			</Paragraph>
			<Paragraph>
			...
			<Paragraph>
                ...
                веб-сайта https://scienteq.ru.
			</Paragraph>
			<Paragraph>2. Основные понятия, используемые в Политике</Paragraph>
			<Paragraph>
			...
			<Paragraph>3. Основные права и обязанности Оператора</Paragraph>
			...
			<Paragraph>
                ...
                Аналитика и других). 5.5. Вышеперечисленные данные далее по
                ...
                субъектов персональных данных. 5.8.1 Согласие на обработку
                персональных данных, разрешенных для распространения,
                Пользователь предоставляет Оператору непосредственно. 5.8.2
                ...
                фамилию, имя, отчество (при наличии), контактную информацию
                (номер телефона, адрес электронной почты или почтовый адрес)
                субъекта персональных данных, а также перечень персональных
                данных, обработка которых подлежит прекращению. Указанные в
                данном требовании персональные данные могут обрабатываться
                только Оператором, которому оно направлено. 5.8.4 Согласие на
                обработку персональных данных, разрешенных для распространения,
                прекращает свое действие с момента поступления Оператору
                требования, указанного в п. 5.8.3 настоящей Политики в отношении
                обработки персональных данных.
			</Paragraph>
			<Paragraph>6. Принципы обработки персональных данных</Paragraph>
			<Paragraph>
                ...
                которые отвечают целям их обработки. 6.5. Содержание и объем
			...
			<Paragraph>7. Цели обработки персональных данных</Paragraph>
			<Paragraph>
                7.1. Цель обработки персональных данных Пользователя: –
                уточнение деталей заказа. 7.2. Также Оператор имеет право
                ...
                scienteq.pro@gmail.com с пометкой «Отказ от уведомлений о новых
                продуктах и услугах и специальных предложениях». 7.3.
			...
			<Paragraph>
                ...
                N 149-ФЗ; – федеральные законы, иные нормативно-правовые акты в
                сфере защиты персональных данных; – согласия Пользователей на
                обработку их персональных данных, на обработку персональных
			...
			<Paragraph>
                ...
                https://scienteq.ru или направленные Оператору посредством
			...
			<Paragraph>
                ...
                принимает решение о предоставлении его персональных данных и
                дает согласие свободно, своей волей и в своем интересе.
			</Paragraph>
			<Paragraph>9. Условия обработки персональных данных</Paragraph>
			<Paragraph>
                9.1. Обработка персональных данных осуществляется с согласия
                субъекта персональных данных на обработку его персональных
                данных. 9.2. Обработка персональных данных необходима для
                ...
                полномочий и обязанностей. 9.3. Обработка персональных данных
			...
			<Paragraph>
                ...
                не нарушаются права и свободы субъекта персональных данных. 9.6.
			...
			<Paragraph>
                ...
                данным неуполномоченных лиц. 10.2. Персональные данные
			...
			<Paragraph>
                ...
                Оператора scienteq.pro@gmail.com с пометкой «Актуализация
                ...
                электронный адрес Оператора scienteq.pro@gmail.com с пометкой
			...
			<Paragraph>
                ...
                поставщиков услуг. 10.6. Установленные субъектом персональных
			...
			<Paragraph>
                ...
                конфиденциальность персональных данных. 10.8. Оператор
			...
			<Paragraph>
                ...
                прав субъектов персональных данных.1. Общие положения
			</Paragraph>
			<Paragraph>
			...
			<Paragraph>14. Заключительные положения</Paragraph>
			<Paragraph>
			...
			<Paragraph>
                ...
                в сети Интернет по адресу https://scienteq.ru/policy.
			</Paragraph>
		</div>
	);
}
